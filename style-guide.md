...
- Hover: небольшое изменение фона/границы и подъём максимум на `1px`; не используй резкие анимации.
...
- Используй `ease` или `cubic-bezier(0.22, 1, 0.36, 1)` для мягкого lift/entrance.
